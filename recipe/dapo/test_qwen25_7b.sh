...
python3 -m recipe.dapo.main_dapo \
    ...
    trainer.resume_from_path=/inspire/hdd/project/video-understanding/public/personal/cktan/reps/verl/rl/new/DAPO-3/DAPO-Qwen2.5-7B-Math-Test/global_step_42
